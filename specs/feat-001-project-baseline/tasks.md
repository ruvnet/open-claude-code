...
- [x] Generate the complete Codex-targeted harness scaffold without forced overwrites.
- [x] Merge strict state and lifecycle contracts into the preserved core files.
- [x] Run all complete-profile validators and the harness skill's acceptance tests.
